 ...
 * @author DELL
 */
public class H2B extends javax.swing.JFrame {

    /**
     * Creates new form H2B
     */
    public H2B() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        jLabel1.setText("HEXADECIMAL TO BINARY");
    ...
    private void b1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_b1ActionPerformed
        ...
        msg=Integer.toBinaryString(num);
        t2.setText(msg);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(H2B.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
